...
import { sessionExecutionCommands as SessionExecutionService } from '@/composition/sessionExecution';
...
describe('SessionExecutionService', () => {
    ...
    describe('completeSet', () => {
        ...
        it('should calculate e1rm and relative intensity if possible', async () => {
            ...
            vi.spyOn(UserProfileRepository, 'getLatestBodyWeight').mockResolvedValue({ weight: 80 } as any);
