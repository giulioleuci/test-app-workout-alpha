...
export class SystemMaintenanceService {
  ...
  static async seedFullBody2x(status: PlannedWorkoutStatus): Promise<void> {
    await seedFullBody2x(status);
  }

  static async seedPPL3x(status: PlannedWorkoutStatus): Promise<void> {
    await seedPPL3x(status);
  }

  static async seedUpperLower4x(status: PlannedWorkoutStatus): Promise<void> {
    await seedUpperLower4x(status);
  }
}
