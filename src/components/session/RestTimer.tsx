...
export default function RestTimer() {
  ...
  const { cancelRestNotifications, scheduleRestNotification } = useNativeDeviceViewModel();
  ...
  }, [cancelRestNotifications, restTimerEndAt, isPaused, restTimerPausedRemaining]);
  ...
  const handleResume = () => {
    ...
    if (restTimerPausedRemaining) {
      void scheduleRestNotification(restTimerPausedRemaining);
    }
  };
...
export function RestTimerStartControl() {
  ...
  const handleStartRest = () => {
    ...
    void scheduleRestNotification(customDuration);
  };
