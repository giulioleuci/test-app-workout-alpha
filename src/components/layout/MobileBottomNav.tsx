          ...
          <nav className="grid grid-cols-3 gap-3 px-2 pt-4">
            {moreItems.map((item) => (
              <NavLink
                key={item.to}
                to={item.to}
                className="text-[14px] flex flex-col items-center justify-center gap-1.5 rounded-xl p-3 text-center text-muted-foreground transition-colors hover:bg-accent"
