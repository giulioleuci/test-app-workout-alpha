    ...
    <div className="flex min-h-screen items-center justify-center bg-background p-6">
      <AnimatePresence mode="wait">
        {step === 'language' && (
          ...
          >
            <Card className="border-none shadow-2xl overflow-hidden min-h-[600px] flex flex-col">
              <CardContent className="flex-1 pt-10 pb-6 space-y-8 text-center overflow-y-auto">
                <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-primary/10">
                  <Languages className="h-8 w-8 text-primary" />
                </div>
                <div className="space-y-2">
                  <h1 className="text-h3 font-black">{t('settings.language')}</h1>
                  <p className="text-sm text-muted-foreground px-4">{t('settings.languageDisclaimer')}</p>
                </div>
            ...
            <Card className="border-none shadow-2xl overflow-hidden min-h-[600px] flex flex-col">
              <div className="flex-1 flex flex-col items-center justify-center p-10 text-center space-y-8">
                <motion.div
                  ...
                  className="mx-auto flex h-24 w-24 items-center justify-center rounded-3xl bg-primary/10 mb-4"
                >
