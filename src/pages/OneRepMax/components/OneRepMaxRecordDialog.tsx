              ...
              <CardContent className="space-y-2 px-4 py-3">
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-right">
                    <span className="text-h4 block font-bold text-primary">{indirectPreview.media} {formUnit}</span>
                ...
                <Accordion type="single" collapsible className="w-full">
                  <AccordionItem value="partial-estimates" className="border-none">
                    <AccordionTrigger className="text-body-sm py-2 text-muted-foreground hover:no-underline">
