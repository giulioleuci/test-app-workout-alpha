            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2 pb-2">
                <Label htmlFor="weight" className="text-xs font-bold uppercase tracking-wider">
                  {t('profile.weightKg')} <span className="text-[10px] lowercase text-muted-foreground font-normal">({t('onboarding.weightOptional')})</span>
                </Label>
                <Input
                  id="weight"
                  type="number"
          ...
          {step === 2 && (
            <div className="space-y-6">
              ...
              <div className="flex gap-3">
                <Button variant="outline" onClick={() => setStep(1)} className="flex-1 h-12 border-2 font-bold">
                  <ArrowLeft className="mr-2 h-4 w-4" />
                  {t('onboarding.back')}
                </Button>
                <Button onClick={handleStart} disabled={isLoading} className="flex-1 h-12 text-base font-bold shadow-lg">
                  {isLoading ? (
                    <>
