...
export function SessionItemHeader({
    ...
    const {
        ...
        onReturnToActiveSet, activeSessionId, simpleMode, onAddWarmupSets
            ...
            <div className="flex min-w-0 flex-1 items-center gap-1.5">
                ...
                {showNavigation && liItem.exercise && displaySet && (
                    <WarmupCalculator
                        ...
                        onInsertSets={(sets) => onAddWarmupSets(liItem.item.id, sets)}
                    />
                )}
                {liItem.plannedItem?.notes && (
                    <NoteViewerButton content={liItem.plannedItem.notes} />
                )}
            </div>
