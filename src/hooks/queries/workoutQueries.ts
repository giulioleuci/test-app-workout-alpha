...
export function useWorkoutList() {
  return useQuery({
    ...
    queryFn: () => workoutCommands.getWorkoutListData(),
    staleTime: Infinity,
  });
}
...
export function useWorkoutDetail(id?: string) {
  return useQuery({
    ...
    queryFn: () => workoutCommands.getWorkoutDetail(id!),
    enabled: !!id,
    staleTime: Infinity,
  });
}
...
export function usePlannedSessionDetail(sessionId?: string) {
  return useQuery({
    ...
    queryFn: () => workoutCommands.getPlannedSessionDetail(sessionId!),
    enabled: !!sessionId,
    staleTime: Infinity,
  });
}
...
export function useSessionTemplates() {
  return useQuery({
    ...
    queryFn: async () => {
      const templates = await templateCommands.getAllTemplates();
...
export function useTemplateDetail(templateId?: string) {
  return useQuery({
    ...
    queryFn: () => templateCommands.getTemplateDetail(templateId!),
    enabled: !!templateId,
    staleTime: Infinity,
  });
}
...
export function useSessionVolume(sessionId: string | null | undefined) {
  return useQuery({
    ...
    queryFn: () => volumeCommands.getSessionVolumeAndDuration(sessionId!),
    enabled: !!sessionId,
    staleTime: Infinity,
  });
}
...
export function useRoutineInsights(workoutId?: string) {
  return useQuery({
    ...
    queryFn: () => workoutCommands.getRoutineInsights(workoutId!),
    enabled: !!workoutId,
    staleTime: Infinity,
  });
}
