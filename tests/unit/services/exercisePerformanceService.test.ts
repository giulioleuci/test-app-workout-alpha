...
import { ExercisePerformanceService, type PerformanceTrendStatus } from '@/services/exercisePerformanceService';

// Access private static method for unit-testing the comparison logic
const compareItems = (
  currentSets: SessionSet[],
  previousSets: SessionSet[],
  previousStatus?: PerformanceTrendStatus,
  hasRangeConstraint = false
): PerformanceTrendStatus =>
  (ExercisePerformanceService as any).compareItems(currentSets, previousSets, previousStatus, hasRangeConstraint);
