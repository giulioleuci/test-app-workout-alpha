...
describe('analyticsService', () => {
  ...
  it('fetches analytics data for the given range and correctly calculates trends', async () => {
    ...
    // Run service
    const data = await analyticsCommands.fetchAnalyticsData({ fromDate: from, toDate: to });
    ...
    // Re-run
    const data2 = await analyticsCommands.fetchAnalyticsData({ fromDate: from, toDate: to });
    ...
    const data3 = await analyticsCommands.fetchAnalyticsData({ fromDate: from, toDate: to });
    ...
    const data4 = await analyticsCommands.fetchAnalyticsData({ fromDate: from, toDate: to });
