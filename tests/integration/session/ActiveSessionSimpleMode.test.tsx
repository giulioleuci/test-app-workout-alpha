...
// Mock analyzer
vi.mock('@/composition/performance', () => ({
  performanceCommands: { analyzeExercisePerformance: vi.fn() },
}));
...
describe('ActiveSession Simple Mode', () => {
  beforeEach(async () => {
    ...
    (performanceCommands.analyzeExercisePerformance as any).mockResolvedValue({
